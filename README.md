...
## Обнаруженные уязвимости (сканирование Docker Scout)
  1. В контейнере PostgreSQL
    ...
    1.2 Наиболее значимые уязвимости по оценкам сканера
      - Уязвимость 1
        - Код уязвимости:
          ```
          CVE-2023-24540
  ...
  2. В контейнере Flask
    ...
    2.1 Общий результат (включая скриншот Уязвимости 1)
  ...
  3. В контейнере Nginx
    ...
    3.2 Наиболее значимые уязвимости по оценкам сканера
      - Уязвимость 1
        - Код уязвимости:
          ```
          CVE-2023-52425⁠
